...
export const PERMISSION_METADATA: PermissionDefinition[] = [
  ...
  { value: 'admin.shorturl.add', category: 'Short URLs', description: 'Create admin short URLs', admin: true },
  { value: 'admin.shorturl.remove', category: 'Short URLs', description: 'Delete admin short URLs', admin: true },
  { value: 'admin.shorturl.edit.own', category: 'Short URLs', description: 'Edit own admin short URLs', admin: true },
  { value: 'admin.shorturl.edit.any', category: 'Short URLs', description: 'Edit any admin short URL', admin: true },
