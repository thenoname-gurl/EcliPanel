    ...
    async (ctx: any) => {
      ...
      if (!dateOfBirth) {
        ...
        return {
          ...
          message: ctx.t('common.invalidDateOfBirth'),
        };
      }
      ...
      if (normalizedEmail && (await isPanelAssignedMailboxEmail(normalizedEmail))) {
        ...
        return {
          ...
          message: ctx.t('auth.registrationEmailReserved'),
        };
      }
      ...
      if ('dateOfBirth' in payload) {
        ...
        if (hasVerifiedDob && existingDob && !isAdmin && requester.id === user.id) {
          if (!existingDob || existingDob.getTime() !== dateOfBirth.getTime()) {
            ...
            return {
              ...
              message: ctx.t('common.dateOfBirthLocked'),
            };
          }
        }
        ...
        if (updatedAge !== null && updatedAge < minimumAge) {
          if (!isAdmin) {
            ...
            return {
              error: 'minimum_age',
              message: `Minimum age is ${minimumAge} years.`,
            };
          }
          user.suspended = true;
          user.fraudFlag = true;
        ...
        if (!normalized) {
          if (field in payload || !existingValue) {
            ...
            return {
              ...
              message: `${requiredProfileFieldLabels[field] || field} is required.`,
            };
          }
        }
      }
