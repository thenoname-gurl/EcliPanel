...
export async function feedbackRoutes(app: any, prefix = '') {
  app.post(prefix + '/feedback', async (ctx: any) => {
    ...
    return { id: feedback.id, rating: feedback.rating, message: feedback.message, createdAt: feedback.createdAt };
  }, {
    beforeHandle: [authenticate],
    detail: { tags: ['Feedback'], summary: 'Submit or update feedback' },
  });

  app.get(prefix + '/feedback', async (ctx: any) => {
    const rolloutCheck = await requireRollout(ctx);
    if (rolloutCheck !== true) return rolloutCheck;
  ...
  app.get(prefix + '/feedback/check', async (ctx: any) => {
    const rolloutCheck = await requireRollout(ctx);
  ...
  app.get(prefix + '/feedback/status', async (ctx: any) => {
    const rolloutCheck = await requireRollout(ctx);
  ...
  app.get(prefix + '/admin/feedback', async (ctx: any) => {
  ...
  app.delete(prefix + '/admin/feedback/:id', async (ctx: any) => {
