...
export async function roleRoutes(app: any, prefix = '') {
  ...
  app.post(
    ...
    async (ctx: any) => {
      ...
      const saved = await roleRepo.findOne({
        where: { id: role.id },
        relations: { permissions: true, parentRole: { permissions: true } },
      });
    ...
    },
    {
      ...
      response: {
        200: t.Object({ success: t.Boolean(), role: t.Any() }),
  ...
  app.post(
    ...
    },
    {
      ...
      response: {
        200: t.Object({ success: t.Boolean(), perm: t.Any() }),
        401: t.Object({ error: t.String() }),
        403: t.Object({ error: t.String() }),
        404: t.Object({ error: t.String() }),
      },
  ...
  app.delete(
    prefix + '/roles/:id/permissions/:permId',
    async (ctx: any) => {
  ...
  app.post(
    ...
    async (ctx: any) => {
      ...
      const userRoleRepo = AppDataSource.getRepository(
    ...
    },
    {
      ...
      response: {
        200: t.Object({ success: t.Boolean(), ur: t.Any() }),
        401: t.Object({ error: t.String() }),
        403: t.Object({ error: t.String() }),
        404: t.Object({ error: t.String() }),
      },
