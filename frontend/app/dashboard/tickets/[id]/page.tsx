        ...
        {!isClosed ? (
          <button
            onClick={() => {
              ...
              className="flex items-center justify-center gap-2 border border-red-500/30 bg-red-500/10 px-4 py-2.5 text-xs sm:text-sm font-medium text-destructive hover:bg-destructive/20 active:scale-[0.98] transition-all w-full"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 border border-green-500/30 bg-green-500/10 px-4 py-2.5 text-xs sm:text-sm font-medium text-success hover:bg-success/20 active:scale-[0.98] transition-all w-full"
          >
  ...
  const AdminPanelContent = () => (
    <div className="flex flex-col gap-3 sm:gap-4">
      ...
      <div className="border-t border-border pt-3 sm:pt-4">
        <p className="text-[9px] sm:text-[10px] font-medium text-destructive uppercase tracking-wider mb-2 sm:mb-3">
          {t("admin.dangerZone")}
        </p>
        <div className="flex flex-col gap-2">
          <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            disabled={deleting}
            className="flex items-center justify-center gap-1.5 border border-red-500/30 px-3 py-2 text-[11px] sm:text-xs font-medium text-destructive hover:bg-destructive/15 active:scale-[0.98] transition-all disabled:opacity-50"
              ...
              <div className="hidden sm:flex items-center gap-1.5">
                {!isClosed ? (
                  <button
                    ...
                    className="flex items-center gap-1.5 border border-red-500/30 bg-red-500/10 px-2.5 py-1.5 text-[11px] sm:text-xs font-medium text-destructive hover:bg-destructive/20 active:scale-[0.98] transition-all"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 border border-green-500/30 bg-green-500/10 px-2.5 py-1.5 text-[11px] sm:text-xs font-medium text-success hover:bg-success/20 active:scale-[0.98] transition-all"
                  >
                      ...
                      {screenshotPreviews.map((url, idx) => (
                        <div key={`pending-${idx}`} className="relative group">
                          ...
                          <button
                            ...
                            className="absolute -top-1.5 -right-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-destructive text-destructive-foreground opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
                          >
                            <X className="h-3 w-3" />
                          </button>
                        </div>
