      ...
      <div className="rounded-xl border border-border bg-card">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-xs text-muted-foreground hidden sm:inline">{organisationsTotal ? `${organisationsTotal} org${organisationsTotal !== 1 ? "s" : ""}` : ""}</span>
            <button
                ...
                <tr>
                  <td colSpan={6} className="px-4 py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">{organisations.length === 0 ? "Loading organisations…" : "No organisations match your search"}</p>
                    </div>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={org.id} className="border-b border-border/50 transition-colors hover:bg-secondary/20 group">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-0.5 opacity-60 group-hover:opacity-100 transition-opacity">
                        <button onClick={() => openEditOrg(org)} title="Edit organisation" className="rounded-md p-1.5 text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors">
                          <Edit className="h-3.5 w-3.5" />
                        </button>
                        <button onClick={() => deleteOrg(org)} title="Delete organisation" className="rounded-md p-1.5 text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors">
      ...
      <div className="rounded-xl border border-border bg-card">
        <div className="flex items-center justify-between gap-3 p-3 sm:p-4">
          <p className="text-xs text-muted-foreground">
            ...
            {organisationsTotal ? <span className="hidden sm:inline"> · {organisationsTotal} total</span> : null}
          </p>
          <div className="flex items-center gap-1.5">
            <Button
              size="sm"
