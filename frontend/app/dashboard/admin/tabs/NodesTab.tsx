              ...
              <div key={node.id} className="rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    {node.organisation && <p className="mt-1 text-xs text-muted-foreground">Org: {redact(node.organisation.name)}</p>}
                  </div>
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <div className="flex gap-1">
                      <Button size="sm" variant="outline" onClick={() => openEditNode(node)} className="border-border h-7 px-2 text-xs gap-1"><Edit className="h-3 w-3" /> Classify</Button>
                      <Button size="sm" variant="outline" onClick={() => viewNodeConfig(node)} className="border-border h-7 px-2 text-xs gap-1" title="View Wings config.yml"><FileCode className="h-3 w-3" /></Button>
                ...
                <div className="mt-3 pt-3 border-t border-border/50">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="text-[11px] text-primary/70 hover:text-primary transition-colors" onClick={() => openHeartbeatHistory(node)}>Full history →</button>
                  </div>
