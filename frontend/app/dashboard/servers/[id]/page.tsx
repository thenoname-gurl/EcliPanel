  ...
  const tabs: TabItem[] = useMemo(() => {
    const baseTabs = [
      ...
      ...(server?.environment?.MINECRAFT_VERSION
        ? [{ id: "minecraft", label: "Minecraft", icon: Users }]
        : []),
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden overscroll-contain">
        <div className="flex flex-col gap-3 p-3 sm:p-4 md:p-6 w-full min-w-0 max-w-full">
          ...
          <div className="border border-border bg-card overflow-hidden min-w-0 w-full">
            ...
            {activeTab === "minecraft" && (
              <Suspense fallback={<LoadingState message="Loading Minecraft..." />}>
                <MinecraftTabLazy serverId={id} server={server} subuserEntry={subuserEntry} />
              </Suspense>
            )}
