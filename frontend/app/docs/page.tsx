...
import { Sparkles, Server, LifeBuoy, Cpu, Rocket, Clock } from "lucide-react";
      ...
      <div className="space-y-8 max-w-6xl">
        <section className="text-center shadow-xl shadow-black/5">
          <div className="">
            ...
            <p className="max-w-3xl mx-auto text-sm leading-7 text-white/70 sm:text-base">
              Learn how to set up your account, deploy servers, manage
              resources, and get help. Each guide walks you through the exact
              screens and features in the panel — from your first login to
        ...
        <section className="flex flex-col gap-0 mt-15">
          ...
          <p className="mt-3 text-[16px] leading-7 text-white/70">
            Use these pages to learn how the panel works, what each page does,
            and what you can do without logging in.
          </p>
        </section>
        ...
        <section className="grid gap-4 sm:grid-cols-2">
          <div className="bg-white/10 p-6">
            ...
            <p className="mt-2 text-[16px] leading-7 text-white/70">
              Register, sign in, verify email, enable 2FA or passkeys, configure
              notifications, and customize your theme and appearance.
            </p>
          </div>
          <div className="bg-white/10 p-6">
            <p className="text-lg font-semibold text-foreground">
            ...
            <p className="mt-2 text-[16px] leading-7 text-white/70">
              Create servers, choose templates, use the console, manage files,
              configure startup commands, set up databases, and monitor resource
              usage.
            </p>
          </div>
          <div className="bg-white/10 p-6">
            ...
            <p className="mt-2 text-[16px] leading-7 text-white/70">
              Deploy the Debian 13 VM, set up SSH key authentication, harden
              your server with UFW, manage services with systemd, and learn
          ...
          <div className="bg-white/10 p-6">
            ...
            <p className="mt-2 text-[16px] leading-7 text-white/70">
              How inactivity notices work for accounts and servers, grace
              periods, what triggers sunset actions, and how to keep your
              services active.
            </p>
          </div>
          <div className="bg-white/10 p-6">
            ...
            <p className="mt-2 text-[16px] leading-7 text-white/70">
              Open support tickets, track conversations, and access the legal
              center for terms of service, privacy policy, acceptable use, and
              more.
            </p>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-0 mt-15">
          ...
          <p className="mt-3 text-[16px] leading-7 text-white/70">
            Start with the page that matches your goal. If you are new to the
            panel, begin with Getting Started. If you already have a server
            running, jump to Server Management or the KVM Guide. Each page
            explains the exact panel screens and features you will use.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-0 mt-15">
          ...
          <p className="mt-3 text-[16px] leading-7 text-white/70">
            For the full terms of service, privacy policy, acceptable use
            policy, and other legal documents, visit the{" "}
            <Link
              href="/legal"
            ...
            . These documents define your rights and responsibilities as a user
            of EcliPanel.
          </p>
        </section>
      </div>
