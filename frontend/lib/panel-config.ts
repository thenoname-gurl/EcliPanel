...
import { Zap, Crown, User, Building2, type LucideIcon } from "lucide-react"
...
export const API_ENDPOINTS = {
  ...
  serverSchedule: "/api/servers/v1/:id/schedules/:sid",
  serverScheduleDelete: "/api/servers/v1/:id/schedules/:sid",
  serverScheduleUpdate: "/api/servers/v1/:id/schedules/:sid",
  serverScheduleTrigger: "/api/servers/v1/:id/schedules/:sid/trigger",
  serverScheduleAbort: "/api/servers/v1/:id/schedules/:sid/abort",
  serverScheduleDuplicate: "/api/servers/v1/:id/schedules/:sid/duplicate",
  serverScheduleExport: "/api/servers/v1/:id/schedules/:sid/export",
  serverScheduleImport: "/api/servers/v1/:id/schedules/import",
  serverScheduleStatus: "/api/servers/v1/:id/schedules/:sid/status",
  serverScheduleSteps: "/api/servers/v1/:id/schedules/:sid/steps",
  serverScheduleStep: "/api/servers/v1/:id/schedules/:sid/steps/:stepId",
  serverScheduleStepDuplicate: "/api/servers/v1/:id/schedules/:sid/steps/:stepId/duplicate",
  serverScheduleStepsOrder: "/api/servers/v1/:id/schedules/:sid/steps/order",
  ...
  serverWorld: "/api/servers/v1/:id/world",
  serverFileSearch: "/api/servers/v1/:id/files/search",
  serverFileStat: "/api/servers/v1/:id/files/stat",
  serverFileSymlink: "/api/servers/v1/:id/files/symlink",
  serverDatabaseBackup: "/api/servers/v1/:id/database-backup",
  serverFirewall: "/api/servers/v1/:id/firewall",
  serverFeatures: "/api/servers/v1/:id/features",
  serverTunnel: "/api/servers/v1/:id/tunnel",
  serverTunnelConnections: "/api/servers/v1/:id/tunnel/connections",
  serverTunnelAvailable: "/api/servers/v1/:id/tunnel/connections/available",
  serverTunnelConnection: "/api/servers/v1/:id/tunnel/connections/:connectionId",
  serverTunnelConnectionAccept: "/api/servers/v1/:id/tunnel/connections/:connectionId/accept",
  nodeTundra: "/api/admin/nodes/:nodeId/tundra",
  nodeTundraSync: "/api/admin/nodes/:nodeId/tundra/sync",
  nodeTundraRotate: "/api/admin/nodes/:nodeId/tundra/rotate",
  nodeTundraMetrics: "/api/admin/nodes/:nodeId/tundra/metrics",
  tundraConfig: "/api/admin/tundra/config",
  tundraNodeConfig: "/api/admin/nodes/:nodeId/tundra/config",
  tundraAcls: "/api/admin/tundra/acls",
  ...
  adminExportJobApprove: "/api/admin/export-jobs/:id/approve",
  ...
  myDataExportRequest: "/api/users/me/export-request",
  myDataExportJobs: "/api/users/me/export-jobs",
