...
export const API_ENDPOINTS = {
  ...
  serverFileUploadToken: "/api/servers/:id/files/upload-token",
  serverFileDownloadToken: "/api/servers/:id/files/download-token",
  ...
  serverFileRevisions: "/api/servers/:id/files/revisions",
  serverFileRevisionContent: "/api/servers/:id/files/revisions/:revisionId",
  serverFileRevisionRestore: "/api/servers/:id/files/revisions/:revisionId/restore",
  serverFileLargestDirectories: "/api/servers/:id/files/largest-directories",
  serverFileShares: "/api/servers/:id/files/shares",
  serverFileShareDelete: "/api/servers/:id/files/shares/:shareId",
  ...
  serverMounts: "/api/servers/:id/mounts",
