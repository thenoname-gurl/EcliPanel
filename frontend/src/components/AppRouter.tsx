...
const staticRoutes: Record<string, Loader> = {
  ...
  "/dashboard/blog/scripts": () => import("@/app/dashboard/blog/scripts/page"), //@es-lint-ignore
  ...
  "/dashboard/drive": () => import("@/app/dashboard/drive/page"),
  ...
  "/dashboard/office": () => import("@/app/dashboard/office/page"),
  ...
  "/dashboard/screen-share": () => import("@/app/dashboard/screen-share/page"),
...
const dynamicRoutes: Array<{ re: RegExp; loader: Loader; keys: string[] }> = [
  ...
  { re: /^\/screen\/([^/]+)$/, keys: ["token"], loader: () => import("@/app/screen/[token]/page") },
  ...
  { re: /^\/dashboard\/office\/([^/]+)$/, keys: ["id"], loader: () => import("@/app/dashboard/office/[id]/page") },
